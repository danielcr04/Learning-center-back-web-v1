...
using Pc2_Tipo1.API.Shared.Infrastructure.Interfaces.ASP.Configuration.Extensions;

namespace Pc2_Tipo1.API.Shared.Infrastructure.Interfaces.ASP.Configuration;
